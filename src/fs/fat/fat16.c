...
static int fat16_get_fat_entry(struct disk* disk, int cluster)
{
    ...
    uint32_t fat_table_position = fat16_get_first_fat_sector(private);
...
/**
 * get correct cluster based on starting cluster and offset
 */
...
// look for an item in directory parsed
